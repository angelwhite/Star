...
function star_setup() {
	...
	add_theme_support( 'custom-background', apply_filters( 'star_custom_background_args', array(
...
function star_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Customer Services', 'star' ),
...
function star_scripts() {
	...
	wp_enqueue_script( 'star-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );
